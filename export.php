...
<script>
  ...
  /**
   * LÓGICA DE PAGINACIÓN COMPLETA Y REUTILIZABLE
   */
  const itemsPerPage = 10;

  // NUEVA FUNCIÓN DE PAGINACIÓN INTELIGENTE
  function renderPagination(container, currentPage, totalItems, onPageClick) {
    ...
    const createButton = (text, page) => {
        ...
        btn.innerHTML = text; // Usar innerHTML para los símbolos
        if (page) {
  ...
  // --- LÓGICA DE MODALES INDIVIDUAL Y CORREGIDA ---
